              ...
              <div className="card card-glow slide-up">
                ...
                <div className="glass p-6 rounded-xl border border-white/20 mb-8">
                  <div className="flex items-center gap-3 mb-3">
                    <Star size={20} className="text-[var(--color-secondary)]" />
                ...
                <div className="space-y-8">
                  {/* Phase 1 */}
                  <div className="glass p-8 rounded-2xl border border-[var(--color-primary)]/30 group hover:border-[var(--color-primary)]/50 transition-all duration-300">
                    <div className="flex items-center gap-4 mb-6">
                      <div className="w-12 h-12 bg-gradient-to-br from-[var(--color-primary)] to-[var(--color-primary-light)] rounded-xl flex items-center justify-center text-white font-bold text-xl group-hover:scale-110 transition-transform duration-300">
                        1
                      </div>
                    ...
                    <div className="glass p-6 rounded-xl border border-white/20">
                      <div className="mb-4">
                        <span className="inline-block bg-[var(--color-primary)]/20 text-[var(--color-primary)] px-3 py-1 rounded-full text-sm font-bold">
                          ANIMATEUR PRINCIPAL
                        </span>
                      </div>
                  ...
                  {/* Phase 2 */}
                  <div className="glass p-8 rounded-2xl border border-[var(--color-secondary)]/30 group hover:border-[var(--color-secondary)]/50 transition-all duration-300">
                    <div className="flex items-center gap-4 mb-6">
                      <div className="w-12 h-12 bg-gradient-to-br from-[var(--color-secondary)] to-[var(--color-secondary-light)] rounded-xl flex items-center justify-center text-black font-bold text-xl group-hover:scale-110 transition-transform duration-300">
                        2
                      </div>
                      <div className="flex-1">
                    ...
                    <div className="space-y-6">
                      <div className="glass p-6 rounded-xl border border-white/20">
                        <div className="mb-4">
                          <span className="inline-block bg-[var(--color-secondary)]/20 text-[var(--color-secondary)] px-3 py-1 rounded-full text-sm font-bold">
                        ...
                        <div className="space-y-3 text-white/90 leading-relaxed">
                          ...
                          <p className="italic text-[var(--color-accent-light)]">
                  ...
                  {/* Phase 3 */}
                  <div className="glass p-8 rounded-2xl border border-[var(--color-accent-light)]/30 group hover:border-[var(--color-accent-light)]/50 transition-all duration-300">
                    <div className="flex items-center gap-4 mb-6">
                      <div className="w-12 h-12 bg-gradient-to-br from-[var(--color-accent-light)] to-blue-600 rounded-xl flex items-center justify-center text-white font-bold text-xl group-hover:scale-110 transition-transform duration-300">
                        3
                      </div>
                      <div className="flex-1">
                    ...
                    <div className="glass p-6 rounded-xl border border-white/20">
                      <div className="mb-4">
                        <span className="inline-block bg-[var(--color-accent-light)]/20 text-[var(--color-accent-light)] px-3 py-1 rounded-full text-sm font-bold">
                          RESPONSABLE ML
                        </span>
                      </div>
                      <div className="space-y-3 text-white/90 leading-relaxed">
                  ...
                  {/* Closing */}
                  <div className="glass p-8 rounded-2xl border border-[var(--color-warning)]/30 group hover:border-[var(--color-warning)]/50 transition-all duration-300">
                    <div className="flex items-center gap-4 mb-6">
                      <div className="w-12 h-12 bg-gradient-to-br from-[var(--color-warning)] to-orange-600 rounded-xl flex items-center justify-center text-white font-bold text-xl group-hover:scale-110 transition-transform duration-300">
                        ✓
                      </div>
                      <div className="flex-1">
                    ...
                    <div className="glass p-6 rounded-xl border border-white/20">
                      <div className="mb-4">
                        <span className="inline-block bg-[var(--color-warning)]/20 text-[var(--color-warning)] px-3 py-1 rounded-full text-sm font-bold">
                          ANIMATEUR PRINCIPAL
                        </span>
                      </div>
                      <div className="space-y-3 text-white/90 leading-relaxed">
                ...
                {/* Tips */}
                <div className="glass p-6 rounded-xl border border-[var(--color-primary)]/30 mt-8">
                ...
                <div className="space-y-8">
                  <div>
                    <h4 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                      <Monitor size={20} className="text-[var(--color-secondary)]" />
                      Matériel nécessaire
                    </h4>
                    <div className="glass p-6 rounded-xl border border-white/20">
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      {[
                        { role: 'Animateur principal', color: 'from-[var(--color-primary)] to-[var(--color-primary-light)]', desc: 'Ouverture, transitions, facilitation des échanges, clôture' },
                        { role: 'Démonstrateur', color: 'from-[var(--color-secondary)] to-[var(--color-secondary-light)]', desc: 'Présentation live du dashboard et des fonctionnalités' },
                        { role: 'Expert ML', color: 'from-[var(--color-accent-light)] to-blue-600', desc: 'Présentation des performances et métriques du modèle' },
            ...
            <div className="card card-glow bounce-in">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div className="space-y-8">
                  <div className="glass p-6 rounded-xl border border-white/20">
                    <h4 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                      <Star size={20} className="text-[var(--color-accent-light)]" />
                      ...
                      {[
                        ...
                        <div key={index}>
                          <div className="flex justify-between items-center mb-2">
                            ...
                            <span className="text-[var(--color-secondary)] text-sm font-bold">{item.progress}%</span>
                          </div>
                  ...
                  <div className="text-center glass p-6 rounded-xl border border-[var(--color-primary)]/30">
